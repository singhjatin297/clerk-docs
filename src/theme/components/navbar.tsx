...
// const NavTreeGroupHeading = ({
//   children,
//   buttonProps = {},
//   ...props
// }: NavTreeGroupHeadingProps) => {
...
// const NavTreeGroupContent = ({
//   children,
//   ...props
// }: NavTreeGroupContentProps) => {
//   const context = useContext(NavTreeGroupContext);
//   return (
//     <Collapsible.Content
//       sx={{
//         overflow: "hidden",
//         animation: buildTransition(
//           (context.open
//             ? animationExpand.toString()
//             : animationCollapse.toString()) as any
//         ),
//       }}
//       {...props}
//     >

...
<Tables
  ...
  rows={[{cells: [
        <code>strategy</code>,
        <code>string</code>,
        <>The OAuth provider that will be used for singing in. Must be one of the supported <a href="#oauthstrategy"><code>OAuthStrategy</code></a>.</>
    ]}, {cells: [
...
<Tables
  ...
  rows={[{cells: [
        ...
        <>This method returns a <code>Promise</code> which resolves to the current <a href="/reference-js/sign-in/sign-in"><code>SignIn</code></a>.</>
    ]}]}
/>

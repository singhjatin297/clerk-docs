...
<Tables
  ...
  rows={[
    {cells: [<code>startMagicLinkFlow</code>, <code>(params: <a href="#signinstartmagiclinkflowparams">SignInStartMagicLinkFlowParams</a>) {"=>"} Promise{"<"}<a href="/reference-js/sign-in/sign-in">SignIn</a>{">"}</code>, <>Function to start the magic link flow. It prepares a magic link verification and polls for the verification result.</>]},
...
*   [`prepareFirstFactor()`](/reference-js/sign-in/first-factor#preparefirstfactor)
*   [`attemptFirstFactor()`](/reference-js/sign-in/first-factor#attemptfirstfactor)

### Second Factor

*   [`prepareSecondFactor()`](/reference-js/sign-in/second-factor#preparesecondfactor)
*   [`attemptSecondFactor()`](/reference-js/sign-in/second-factor#attemptsecondfactor)

### Authenticate With

*   [`authenticateWithRedirect()`](/reference-js/sign-in/authenticate-with#authenticatewithredirect)
*   [`authenticateWithMetamask()`](/reference-js/sign-in/authenticate-with#authenticatewithmetamask)
*   [`authenticateWithWeb3()`](/reference-js/sign-in/authenticate-with#authenticatewithweb3)

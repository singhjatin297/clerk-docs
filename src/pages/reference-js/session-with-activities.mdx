...
The `SessionWithActivities` object is a modified [Session](/reference-js/session) object. It contains most of the information that the `Session` object stores, adding extra information about the current session's latest activity.

...
These are all methods on [the `SignUp` class](/reference-js/sign-up/sign-up) that allow you to verify a user's sign-up request via a web3 wallet.
...
This is equivalent to calling [`SignUp.prepareVerification("web3_metamask_signature")`](/reference-js/sign-up/verification#prepareverification).
...
This is equivalent to calling [`SignUp.attemptVerification({strategy: "web3_metamask_signature", signature: "..." })`](/reference-js/sign-up/verification#attemptverification).

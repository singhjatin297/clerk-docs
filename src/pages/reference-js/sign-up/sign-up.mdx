...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}, {maxWidth: "300px"}]}
  rows={[
    {cells: [<code>startMagicLinkFlow</code>, <code>(params: <a href="#startmagiclinkflowparams">StartMagicLinkFlowParams</a>) {"=>"} Promise{"<"}<a href="/reference-js/sign-up/sign-up">SignUp</a>{">"}</code>, <>Function to start the magic link flow. It prepares a magic link verification and polls for the verification result.</>]},
...
*   [`authenticateWithRedirect()`](/reference-js/sign-up/authenticate-with#authenticatewithredirect)
*   [`authenticateWithMetamask()`](/reference-js/sign-up/authenticate-with#authenticatewithmetamask)
*   [`authenticateWithWeb3()`](/reference-js/sign-up/authenticate-with#authenticatewithweb3)

### Verification

*   [`prepareVerification()`](/reference-js/sign-up/verification#prepareverification)
*   [`attemptVerification()`](/reference-js/sign-up/verification#attemptverification)

### Email Verification

*   [`prepareEmailAddressVerification()`](/reference-js/sign-up/email-verification#prepareemailaddressverification)
*   [`attemptEmailAddressVerification()`](/reference-js/sign-up/email-verification#attemptemailaddressverification)

### Phone Verification

*   [`preparePhoneNumberVerification()`](/reference-js/sign-up/phone-verification#preparephonenumberverification)
*   [`attemptPhoneNumberVerification()`](/reference-js/sign-up/phone-verification#attemptphonenumberverification)

### Web3 Verification

*   [`prepareWeb3WalletVerification()`](/reference-js/sign-up/web3-verification#prepareweb3walletverification)
*   [`attemptWeb3WalletVerification()`](/reference-js/sign-up/web3-verification#attemptweb3walletverification)
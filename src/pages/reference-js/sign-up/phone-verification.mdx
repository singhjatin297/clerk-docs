...
These are all methods on [the `SignUp` class](/reference-js/sign-up/sign-up) that allow you to verify a user's sign-up request via a phone number.
...
This is equivalent to calling [`SignUp.prepareVerification("phone_code")`](/reference-js/sign-up/verification#prepareverification).
...
This is equivalent to calling [`SignUp.attemptVerification({strategy: "phone_code", ...params})`](/reference-js/sign-up/verification#attemptverification).

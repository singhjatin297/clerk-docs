...
<Tables
  ...
  <>The <code>{`<div>`}</code> element used to render in the organization-switcher component</>
  ],
  },
  {
  cells: [
  "props?",
  <a href="#organizationswitcherprops"><code>OrganizationSwitcherProps</code></a>,
  "The properties to pass to the organization-switcher component",
  ],
  },
  ]}
/>
...
<Tables
  ...
  "node",
  <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLDivElement"><code>HTMLDivElement</code></a>,
  <>The container <code>{`<div>`}</code> element with a rendered organization-switcher component instance</>
  ],
  },
  ]}
/>

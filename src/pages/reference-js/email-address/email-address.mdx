...
{cells: [<code>verification</code>, <a href="/reference-js/verification"><code>Verification</code></a>, <>An object holding information on the verification of this email address.</>]},
...
*   [`prepareVerification()`](/reference-js/email-address/verification#prepareverification)
*   [`attemptVerification()`](/reference-js/email-address/verification#attemptverification)

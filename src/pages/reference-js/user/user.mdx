...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<code>Promise{"<"}<a href="/reference-js/session-with-activities">SessionWithActivities</a>[]{">"}</code>, <>The list of active user sessions.</>]}
 ]}
  />
...
<a href="/reference-js/email-address/email-address">EmailAddress</a> | <a href="/reference-js/phone-number/phone-number">PhoneNumber</a> | <a href="/reference-js/web3-wallet/web3-wallet">Web3Wallet</a>
...
*   [`createTOTP()`](/reference-js/user/totp#createtotp)
*   [`verifyTOTP()`](/reference-js/user/totp#verifytotp)
*   [`disableTOTP()`](/reference-js/user/totp#disabletotp)
*   [`createBackupCode()`](/reference-js/user/totp#createbackupcode)

### Password Management

*   [`updatePassword()`](/reference-js/user/password-management#updatepassword)
*   [`removePassword()`](/reference-js/user/password-management#removepassword)

### Create Metadata

*   [`createEmailAddress()`](/reference-js/user/create-metadata#createemailaddress)
*   [`createPhoneNumber()`](/reference-js/user/create-metadata#createphonenumber)
*   [`createWeb3Wallet()`](/reference-js/user/create-metadata#createweb3wallet)
*   [`createExternalAccount()`](/reference-js/user/create-metadata#createexternalaccount)
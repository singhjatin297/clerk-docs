...
<Tables
  ...
  rows={[
{cells: [<code>Promise{"<"}<a href="#totpresource">TOTPResource</a>{">"}</code>, <>The newly created TOTP object.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<code>Promise{"<"}<a href="#totpresource">TOTPResource</a>{">"}</code>, <>The newly verified TOTP object.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<code>Promise{"<"}<a href="/reference-js/types/deleted-object">DeletedObject</a>{">"}</code>, <>The a reference to the deleted TOTP object.</>]}
 ]}
  />
...
<Tables
  ...
  headingsMeta={[{}, {maxWidth: "300px"}]}
  rows={[
{cells: [<code>Promise{"<"}<a href="#backupcoderesource">BackupCodeResource</a>{">"}</code>, <>The newly created backup code.</>]}
 ]}
  />

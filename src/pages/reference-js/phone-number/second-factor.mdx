...
These are all methods on [the `PhoneNumber` class](/reference-js/phone-number/phone-number) that allow you configure the configuration of a phone number as a second factor for multi-factor authentication (MFA).

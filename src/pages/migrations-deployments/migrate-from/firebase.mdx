...
Now you have all the information you need to import your Firebase users into Clerk. In this example we are going to use node to do so, but you can use any other language or method if you so wish.
...
#### Create a script
```js filename="your-project/migrate-to-clerk.js" copy

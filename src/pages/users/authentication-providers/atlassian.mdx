...
Adding social connection with Atlassian to your app with Clerk is straightforward - you will need to populate the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
...
> The purpose of this guide is to help you create an Atlassian account and an Atlassian OAuth 2.0 Integration - if you're looking for step-by-step  instructions using Clerk to add social connection (OAuth) to your  application, follow the [Social connection (OAuth) guide](https://clerk.com/docs/authentication/social-connections-oauth).
...
![Atlassian app listing](./atlassian/37ec3daaa6d6eaa060ad7fecb112ae6d1ef46597-3456x1844.png)

From there, click on the desired existing app or create a new one, which will take you to the app page.

![Atlassian OAuth 2.0 app page](./atlassian/597e9bdc5a6b521bcbf8223c04a1102683bf9231-3456x1730.png)
...
![](./atlassian/b2762ea10eebe6f05f39aa9ed33c54ca41bc2f3d-3456x1730.png)

From the app page, click on the **Permissions** tab in the sidebar menu.

![Atlassian OAuth 2.0 Integration permissions](./atlassian/04fa49b7d9ba58c0faf2c2b97f85b5ea17a9ebe6-3456x1730.png)
...
![Atlassian OAuth 2.0 Authorization page](./atlassian/3d60a54bb48c03257afbf769f1f50cf45f18871c-3456x1730.png)

In this section you will need to paste the Authorized redirect URI that Clerk has provided for you.

![Atlassian OAuth 2.0 App callback URL settings](./atlassian/a6dc9bd0902359cad9c94de1bdcbd4c9112bff1d-3456x1730.png)

After entering the callback URL, the Client ID & Client Secret will now be available in the **Settings** tab:

![](./atlassian/fdc89459cdc6450c4dbde713e7b840d93b01c862-3456x1730.png)
...
![Client ID and Client Secret inputs for Atlassian connection](./atlassian/6ef7100945fb68a379b35a5c295a76405a2cf10e-1156x1354.png)
...
![Atlassian OAuth 2.0 app distribution settings](./atlassian/83d5498c454f5ba0b92a76c4a1942e9a07cde48d-3456x1730.png)
...
![Atlassian OAuth2 distribution sharing form](./atlassian/07c724b9a66773c94c169cc2a199a549c45d8fdd-3456x1730.png)
...
That's it, now you are all set to sign up & sign in to Clerk with Atlassian!

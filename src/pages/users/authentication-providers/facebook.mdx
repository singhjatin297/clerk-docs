...
Adding social connection with Facebook to your app with Clerk is simple - you only need to set the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
...
> The purpose of this guide is to help you setup a Facebook developer account and a Facebook OAuth2.0 project - if you're looking for step-by-step  instructions using Clerk to add Social Connection (OAuth) to your  application, follow the [Social connection (OAuth) guide](https://clerk.com/docs/authentication/social-connections-oauth).
...
![Creating a Facebook app](./facebook/473ca20025e0f1fa7bae18d07ee6e990e171bb42-1391x969.png)
...
![Enabling Facebook Login for your app](./facebook/98c66e38465c348c45718d32b4404b5fcb291896-1467x969.png)
...
![Retrieving the App ID and App Secret](./facebook/33456604106d3478e0fd6b583bdde7c4f5563641-1467x969.png)

Go to the [Social Connections page](https://dashboard.clerk.dev/last-active?path=authentication/social) and enable Facebook. In the modal that opened, ensure **Use custom credentials** is enabled and paste the values you obtained during the previous step.

![Adding the valid OAuth Redirect URI](./facebook/c0be80ce8fed2b4d14d04fcbf56318b80295093d-1467x989.png)
...
Don't forget to click **Apply** in the Clerk dashboard. Social connection with Facebook is now configured.

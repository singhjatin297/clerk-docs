...
![Creating an OAuth client ID in Google Cloud console](./google/700f6f127f579f46032602391223bb42bd807b06-1696x992.png)
...
![Copy the Client ID and Client Secret](./google/097b6afe678dc7c07efe5e6fc5ca78b46a002ee5-1696x992.png)
...
![Client ID and Client secret filled in. Authorized redirect URI copied and entered into Google Cloud Platform console.](./google/8bf67be45ecccaf962a881fb09a61ed810e818cf-563x869.png)

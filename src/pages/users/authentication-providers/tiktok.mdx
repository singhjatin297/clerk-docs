...
Adding social connection with TikTok to your app with Clerk is simple - you only need to set the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
...
> The purpose of this guide is to help you setup a TikTok developer account  and a TikTok OAuth app - if you're looking for step-by-step instructions using Clerk to add social connection (OAuth) to your application,  follow the [Social connection (OAuth) guide](https://clerk.com/docs/authentication/social-connections-oauth).
...
![Creating a new TikTok app](./tiktok/9a5749a9bf3f282c54af2a2b539ba372e4706574-1489x964.png)

Add an icon and a name for your new project and hit **Start**.

You'll get redirected to the app creation form. Notice that you need to fill the **Callback URL** and **Redirect domain** fields. Go to the [Social Connections page](https://dashboard.clerk.dev/last-active?path=authentication/social) and enable TikTok. In the modal that opened, ensure **Use custom credentials** is enabled and copy **Authorized redirect URI**.

![Filling in the Callback URL and Redirect Domain fields](./tiktok/135491407e1afeea187644e4450fb77bb659d907-1489x964.png)
...
![Obtaining the Client Key and Client Secret](./tiktok/12885db4568578459fb4b9beab31838c929cf9d5-1382x833.png)

Don't forget to click **Apply** in the Clerk dashboard. Social connection with TikTok is now configured.

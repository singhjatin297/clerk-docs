...
Adding social connection with Bitbucket to your app with Clerk is straightforward - you will need to populate the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
...
> The purpose of this guide is to help you create a Bitbucket account and a  Bitbucket OAuth Consumer - if you're looking for step-by-step  instructions using Clerk to add social connection (OAuth) to your  application, follow the [Social connection (OAuth) guide](https://clerk.com/docs/authentication/social-connections-oauth).
...
![Bitbucket workspace listing](./bitbucket/005f4b20222a0641a443f750e24d26fd088324db-3360x1896.png)

From there, click on the desired existing workspace or create a new one, then navigate to:

**Settings** > **Oauth Consumers**

![Bitbucket OAuth Consumer list](./bitbucket/b072d3a9f269a46468e651646d08522aa253fdaf-3360x1782.png)
...
![OAuth consumer creation](./bitbucket/3c3f5f49188f740839a9e0f348ffe4d34a5300c3-3360x1782.png)
...
![Bitbucket OAuth Consumer scopes](./bitbucket/65aee792cbde8564897d5f1110caf090789bf532-1304x942.png)
...
![Client ID and Client Secret inputs for Bitbucket connection](./bitbucket/c29fd970821d0746e7637f69bf8f411695638834-1220x784.png)

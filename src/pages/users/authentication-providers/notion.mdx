...
How to setup social connection with Notion

## Overview

Adding social connection with Notion to your app with Clerk is simple - you only need to set the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
...
![](./notion/8bfb8db037003ce2d8e3dc931cdde601d402703b-1148x1480.png)
...
![](./notion/038afa1d5298fc84d142aa5a9dd97317ddc245b4-1177x2165.png)
...
![](./notion/ab4bc9eea6e1033cd0a30d539e196c30b07399ba-1173x766.png)

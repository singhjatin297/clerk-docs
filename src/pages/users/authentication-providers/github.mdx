...
Adding social connection with GitHub to your app with Clerk is simple - you only need to set the **Client ID**, **Client Secret** and **Authorized redirect URI** in your instance settings.
...
> The purpose of this guide is to help you create a GitHub account and a  GitHub OAuth app - if you're looking for step-by-step instructions using Clerk to add social connection (OAuth) to your application, follow the [Social connection (OAuth) guide](https://clerk.com/docs/authentication/social-connections-oauth).
...
![Registering an OAuth GitHub app](./github/ff83ad81ca491cf17e5a755376fae9c88148ce7c-1395x799.png)
...
![Obtaining the Client ID and Client secret](./github/3b1f58462fab3cc238c1a59994d1e2eb98f46b73-1489x964.png)

Don't forget to click **Apply** in the Clerk dashboard. Social connection with GitHub is now configured.

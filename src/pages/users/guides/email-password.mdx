...
In some cases, our Clerk components may not work for your product which is why we provide the useSignUp and useSignIn hooks. These hooks allow you to build your own custom sign up and sign in flows.
...
![example of enabling email and password](/images/users/guides/custom-flows/email-password/enable-email-password.png)
